import { RuleRunner } from "../../../domain/rule-runner/rule-runner";
import { Rule, Rules } from "../../../domain/rule-runner/rules/rule";
...
import { CulDeChouetteRule } from "../../../domain/rule-runner/rules/basic-rules/cul-de-chouette-rule";
import { SuiteRule } from "../../../domain/rule-runner/rules/basic-rules/suite-rule";
import { ChouetteVeluteRule } from "../../../domain/rule-runner/rules/basic-rules/chouette-velute-rule";
import { VeluteRule } from "../../../domain/rule-runner/rules/basic-rules/velute-rule";
import { AttrapeOiseauRule } from "../../../domain/rule-runner/rules/level-1/attrape-oiseau-rule";
import { SirotageRule } from "../../../domain/rule-runner/rules/level-1/sirotage-rule";
import { ChouetteRule } from "../../../domain/rule-runner/rules/basic-rules/chouette-rule";
import { NeantRule } from "../../../domain/rule-runner/rules/basic-rules/neant-rule";
import { GrelottineRuleResolver } from "./resolvers/grelottine-rule-resolver";
import { GrelottineRule } from "../../../domain/rule-runner/rules/basic-rules/grelottine-rule";
import { BevueRule } from "../../../domain/rule-runner/rules/basic-rules/bevue-rule";
import { SouffletteRule } from "../../../domain/rule-runner/rules/level-1/soufflette-rule";
...
import { BleuRougeRule } from "../../../domain/rule-runner/rules/level-3/bleu-rouge-rule";
import { CivetRule } from "../../../domain/rule-runner/rules/level-1/civet-rule";
import { CivetRuleResolver } from "./resolvers/civet-rule-resolver";
import { ArtichetteRule } from "../../../domain/rule-runner/rules/level-2/artichette-rule";
import { ArtichetteRuleResolver } from "@/store/current-game/resolvers/artichette-rule-resolver";
import { VerdierRule } from "../../../domain/rule-runner/rules/level-3/verdier-rule";
